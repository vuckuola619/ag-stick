...
PROJECT_DIR = r"c:\Users\bati-\Documents\AG-Stick\projects\white-phosphorus-10min"
AUDIO_DIR = os.path.join(PROJECT_DIR, "audio")
SCENES_AUDIO_DIR = os.path.join(AUDIO_DIR, "scenes")
REMOTION_PUBLIC_ASSETS = r"c:\Users\bati-\Documents\AG-Stick\projects\wework-47-billion-illusion\remotion\public\assets\white_phosphorus"
...
MANIFEST_OUT = os.path.join(PROJECT_DIR, "script", "white_phosphorus_manifest.json")
...
def main():
    ...
    for idx, sc in enumerate(scenes):
        ...
        scene_info = {
            ...
            "audio_file": f"assets/white_phosphorus/audio/scenes/scene_{s_id}.wav",
            "image_file": f"assets/white_phosphorus/scenes/scene_{s_id}.png",
    ...
    print(f"Saved raw voiceover: {raw_wav_path}")
    ...
    print("Mastering audio via FFmpeg (High-pass 80Hz + EBU R128 -16.0 LUFS)...")
    cmd = [
        FFMPEG, "-y",
        "-i", raw_wav_path,
    ...
    print(f"Saved mastered WAV: {mastered_wav_path}")
    
    # Also export MP3 for lightweight preview
    cmd_mp3 = [
        FFMPEG, "-y",
        "-i", mastered_wav_path,
        "-b:a", "192k",
    ...
    print(f"Saved mastered MP3: {mastered_mp3_path}")
    
    # Copy to Remotion public assets
    shutil.copyfile(mastered_wav_path, remotion_wav_path)
    print(f"Copied to Remotion: {remotion_wav_path}")
    ...
    print(f"Saved synced manifests: {MANIFEST_OUT} and {MANIFEST_REMOTION}")
    print("Audio engineering pipeline completed successfully!")
