...
scenes_data = [
    ...
    },
    {
        ...
        "end_sec": 40.0,
        "duration_sec": 20.0,
        "kinetic_hook_headline": "TARGET: TOKYO",
        "voiceover_text": "This was Rufus, the third plutonium pit engineered by the Manhattan Project. It was scheduled to be loaded into a B-29 bomber and dropped onto Kokura or Tokyo. But when Japan surrendered unconditionally on August 15th, Rufus was abruptly canceled, leaving the world's deadliest weapon stranded on a laboratory workbench.",
        "codex_image_prompt": "Minimalist 2D cartoon stick figure military general with a solid blank white circular head (#ffffff), simple focused cartoon eyes, wearing a 1940s olive-drab army uniform with a necktie, holding a stamped cancellation dossier over a large map of the Pacific theater, beside a silhouette of a heavy propeller bomber aircraft, dark slate background (#161820), muted military olive and subtle amber highlights, flat 2D vector style, bold 8-10px black ink outlines, strictly no text, no letters, no words, no 3D render."
    },
    {
        "scene_id": "03",
        "act": 1,
    ...
    # ACT 3: INCIDENT 1 — HARRY DAGHLIAN (4:00 – 5:45)
    {
        "scene_id": "14",
        "act": 3,
        "act_title": "Incident 1: Harry Daghlian",
        "timestamp_range": "4:00 - 4:18",
        "start_sec": 240.0,
        "end_sec": 258.0,
        "duration_sec": 18.0,
        "kinetic_hook_headline": "AUGUST 21, 1945",
        "voiceover_text": "On the night of August 21st, 1945, twenty-four-year-old physicist Harry Daghlian walked into the Omega Site laboratory shortly after nine o'clock. Working completely against official regulations, he decided to perform a manual assembly alone, accompanied only by a seated military guard named Robert Hemmerly.",
        "codex_image_prompt": "Minimalist 2D cartoon stick figure young scientist with a solid blank white circular head (#ffffff), simple focused cartoon eyes, wearing a collared white shirt and tie, walking into an empty wooden research facility carrying a clipboard toward a central assembly table, dark slate room (#12141A) illuminated by vintage green-shaded lamps, flat 2D vector art, bold 8-10px black outlines, strictly no text, no clocks, no calendar, no 3D CGI."
    },
    {
        "scene_id": "15",
        "act": 3,
        "act_title": "Incident 1: Harry Daghlian",
        "timestamp_range": "4:18 - 4:36",
        "start_sec": 258.0,
        "end_sec": 276.0,
        "duration_sec": 18.0,
        "kinetic_hook_headline": "THE FATAL SLIP",
        "voiceover_text": "Daghlian built a four-sided wall of tungsten carbide bricks around the plutonium sphere. As he carefully hoisted the final four-point-four kilogram brick to place it directly above the core, the radiation counter screamed. Daghlian flinched. The heavy, polished brick slipped from his sweaty fingers.",
        "codex_image_prompt": "Minimalist 2D cartoon stick figure scientist with a solid blank white circular head (#ffffff), sudden terrified cartoon eyes with shock lines, stick hands losing grip as a heavy rectangular dark brick slips mid-air directly downward toward an open pit containing a metallic sphere, dark charcoal background (#141620), dynamic motion trail lines and warning amber glow, flat 2D vector illustration, bold 10px black stroke, strictly no text, no comic bursts, no 3D render."
    },
    {
        "scene_id": "16",
        "act": 3,
        "act_title": "Incident 1: Harry Daghlian",
        "timestamp_range": "4:36 - 4:54",
        "start_sec": 276.0,
        "end_sec": 294.0,
        "duration_sec": 18.0,
        "kinetic_hook_headline": "THE BLUE FLASH",
        "voiceover_text": "The brick crashed directly onto the top of the core. Instantly, the assembly went prompt critical. A brilliant, ethereal blast of blue-violet light erupted into the room, accompanied by an intense wave of radiant heat that washed over Daghlian’s face and chest like an open blast furnace.",
        "codex_image_prompt": "Minimalist 2D cartoon stick figure scientist centered in dramatic silhouette, shielding his white circular head with an arm as a blinding radiant explosion of electric cobalt-blue ionization light (#00E5FF and #0055FF) erupts from the central table, radiating sharp vector energy shockwaves into a pitch-dark room, clean flat 2D cartoon, bold black silhouette, strictly no text, no lettering, no 3D CGI, no photorealism."
    },
    {
        "scene_id": "17",
        "act": 3,
        "act_title": "Incident 1: Harry Daghlian",
        "timestamp_range": "4:54 - 5:12",
        "start_sec": 294.0,
        "end_sec": 312.0,
        "duration_sec": 18.0,
        "kinetic_hook_headline": "BARE-HAND TEARDOWN",
        "voiceover_text": "Reacting on pure survival instinct, Daghlian lunged forward. He tried to shove the fallen brick off the core, but it was too slippery. In sheer panic, he used his bare hands to violently knock down the entire incandescent stack of heavy bricks, scattering them across the wooden floor.",
        "codex_image_prompt": "Minimalist 2D cartoon stick figure scientist with a solid blank white circular head (#ffffff), desperate wide cartoon eyes, lunging forward with extended stick arms to push over a tumbling stack of rectangular bricks surrounding a glowing sphere, bricks flying across the wooden floorboards, dark slate background (#13151D), glowing blue residual aura around the core, flat 2D vector cartoon, bold 8-10px strokes, strictly no text, no 3D effects."
    },
    {
        "scene_id": "18",
        "act": 3,
        "act_title": "Incident 1: Harry Daghlian",
        "timestamp_range": "5:12 - 5:30",
        "start_sec": 312.0,
        "end_sec": 330.0,
        "duration_sec": 18.0,
        "kinetic_hook_headline": "510 REMS OF DOSE",
        "voiceover_text": "The entire criticality burst lasted barely a few seconds, but the invisible damage was catastrophic. Daghlian had absorbed an estimated five hundred and ten rems of massive neutron and gamma radiation. His right hand alone, which had dismantled the stack, absorbed over twenty thousand rads of blistering thermal exposure.",
        "codex_image_prompt": "Minimalist 2D stylized medical diagram showing a stick figure silhouette with right stick hand and chest highlighted in glowing hazard orange and toxic red radiation fracture patterns, beside stylized floating DNA double helix strands snapping and breaking, dark charcoal background (#111319), bright warning crimson (#FF1133) and electric cyan (#00E5FF) accents, flat 2D vector style, bold outlines, strictly no text, no medical charts, no labels, no 3D render."
    },
    {
        "scene_id": "19",
        "act": 3,
        "act_title": "Incident 1: Harry Daghlian",
        "timestamp_range": "5:30 - 5:45",
        "start_sec": 330.0,
        "end_sec": 345.0,
        "duration_sec": 15.0,
        "kinetic_hook_headline": "THE DEMON CORE IS BORN",
        "voiceover_text": "Within hours, severe nausea and swelling set in. Daghlian was rushed to the Los Alamos hospital, where his blistered skin turned necrotic and his organs steadily shut down. He died twenty-five days later, on September 15th. From that dark day forward, the metal sphere was rechristened: The Demon Core.",
        "codex_image_prompt": "Minimalist 2D cartoon stick figure hospital patient lying in a stark metal hospital bed, beside a somber doctor stick figure in a lab coat bowing his head, dramatic deep charcoal background (#101217) with a single spotlight, subtle somber purple-crimson rim lighting, flat 2D vector art, bold clean outlines, strictly no text, no monitors, no lettering, no 3D CGI."
    },
    ...
    # ACT 4: INCIDENT 2 — LOUIS SLOTIN & THE SCREWDRIVER (5:45 – 8:00)
    {
        "scene_id": "20",
        "act": 4,
        "act_title": "Incident 2: Louis Slotin & The Screwdriver",
        "timestamp_range": "5:45 - 6:05",
        "start_sec": 345.0,
        "end_sec": 365.0,
        "duration_sec": 20.0,
        "kinetic_hook_headline": "THE DAREDEVIL PHYSICIST",
        "voiceover_text": "Following Daghlian's death, safety guidelines were drafted, but the culture of bravado persisted. Leadership of the critical assembly group passed to thirty-five-year-old Canadian physicist Louis Slotin. Brilliant, charismatic, and fearless, Slotin wore cowboy boots, blue jeans, and lived for the intoxicating thrill of mastering chain reactions.",
        "codex_image_prompt": "Minimalist 2D cartoon stick figure scientist with a solid blank white circular head (#ffffff), confident smiling cartoon eyes, wearing a vintage 1940s western denim shirt, necktie, and cowboy boots, standing proudly with arms crossed beside a scientific workbench, dark slate background (#141720) with warm studio rim lighting (#FFAA00), clean flat 2D vector linework, bold 8-10px black strokes, strictly no text, no western logos, no 3D render."
    },
    {
        "scene_id": "21",
        "act": 4,
        "act_title": "Incident 2: Louis Slotin & The Screwdriver",
        "timestamp_range": "6:05 - 6:25",
        "start_sec": 365.0,
        "end_sec": 385.0,
        "duration_sec": 20.0,
        "kinetic_hook_headline": "MAY 21, 1946",
        "voiceover_text": "On May 21st, 1946, Slotin was preparing to hand over his duties before the core was shipped to Bikini Atoll for atomic tests. Seven other scientists and observers gathered inside the Omega Site laboratory to watch Slotin demonstrate what he casually referred to as his trademark criticality procedure.",
        "codex_image_prompt": "Minimalist 2D cartoon scene showing eight distinct cartoon stick figures with solid white circular heads (#ffffff) gathered in a semi-circle around a central assembly table, all wearing 1940s white coats, military uniforms, and office attire, looking attentively inward, dark charcoal laboratory interior (#12141A) with overhead fluorescent lighting, flat 2D vector style, clean bold outlines, strictly no text, no badges, no 3D CGI."
    },
    {
        "scene_id": "22",
        "act": 4,
        "act_title": "Incident 2: Louis Slotin & The Screwdriver",
        "timestamp_range": "6:25 - 6:45",
        "start_sec": 385.0,
        "end_sec": 405.0,
        "duration_sec": 20.0,
        "kinetic_hook_headline": "BERYLLIUM CLAMSHELL",
        "voiceover_text": "This time, the reflector was not heavy bricks, but two nested, nine-inch hollow hemispheres made of pure beryllium. The bottom hemisphere sat in a metal cradle holding the plutonium core. Slotin’s task was to slowly lower the upper dome over the core to measure neutron multiplication through the remaining gap.",
    ...
    # ACT 5: THE AFTERMATH & LEGACY (8:00 – 10:00)
    {
        "scene_id": "27",
        "act": 5,
        "act_title": "The Aftermath & Legacy",
        "timestamp_range": "8:00 - 8:20",
        "start_sec": 480.0,
        "end_sec": 500.0,
        "duration_sec": 20.0,
        "kinetic_hook_headline": "CHALK ON THE FLOOR",
        "voiceover_text": "Slotin knew immediately that his life was forfeit. Remaining astonishingly clear-headed, he ordered everyone to stay frozen in place. Using a piece of white blackboard chalk, Slotin marked the exact spot on the wooden floor where every single person had stood, enabling medical physicists to calculate their precise radiation exposure.",
        "codex_image_prompt": "Minimalist 2D cartoon stick figure scientist kneeling on the wooden floor with a stick of chalk, drawing numbered circular chalk rings where various stick figure colleagues stand motionless, overhead isometric perspective of the laboratory floor, dark slate background (#13151E), crisp white floor markings and subtle green-tinted shadows, flat 2D vector style, bold 8px outlines, strictly no text, no words, no letters, no 3D CGI."
    },
    {
        "scene_id": "28",
        "act": 5,
        "act_title": "The Aftermath & Legacy",
        "timestamp_range": "8:20 - 8:40",
        "start_sec": 500.0,
        "end_sec": 520.0,
        "duration_sec": 20.0,
        "kinetic_hook_headline": "1,000 RADS",
        ...
        "codex_image_prompt": "Minimalist 2D stylized medical representation of nuclear decay: a somber medical room silhouette with a centered hospital bed, beside a giant stylized hourglass filled with glowing radiant sand grains trickling downward into darkness, dark charcoal background (#101116), somber purple and pale amber rim lighting, flat 2D vector art, bold clean outlines, strictly no text, no numbers, no 3D render."
    },
    {
        "scene_id": "29",
        "act": 5,
        "act_title": "The Aftermath & Legacy",
        "timestamp_range": "8:40 - 9:00",
        "start_sec": 520.0,
        "end_sec": 540.0,
        "duration_sec": 20.0,
        "kinetic_hook_headline": "THE SURVIVORS",
        "voiceover_text": "Because Slotin's body had physically absorbed the brunt of the neutron blast, all seven other men survived. However, the phantom of radiation followed them for decades. Several developed premature cataracts, chronic blood disorders, and psychological scars that never fully healed, serving as living testaments to that fateful afternoon in Pajarito Canyon.",
        "codex_image_prompt": "Minimalist 2D cartoon illustration of three surviving stick figure scientists in 1950s suits walking away from the laboratory into the desert sun, casting long dark shadows behind them, dark slate canyon background (#141722) transitioning to warm desert horizon, subtle electric blue edge glow on their silhouettes, flat 2D vector cartoon, bold 8-10px black strokes, strictly no text, no signs, no 3D CGI."
    },
    {
        "scene_id": "30",
        "act": 5,
        "act_title": "The Aftermath & Legacy",
        "timestamp_range": "9:00 - 9:20",
        "start_sec": 540.0,
        "end_sec": 560.0,
        "duration_sec": 20.0,
        "kinetic_hook_headline": "REMOTE CONTROL ONLY",
        "voiceover_text": "The second disaster was the final straw. Laboratory director Norris Bradbury and General Leslie Groves immediately issued an absolute, permanent ban on all manual criticality experiments. Never again would a human being touch a fissile core. From that moment on, all criticality tests were conducted entirely by remote-controlled robotic manipulators.",
        "codex_image_prompt": "Minimalist 2D cartoon robotic steel mechanical claw arm operated by remote cables and pulleys, carefully lowering a metallic hemisphere onto a core from behind a thick lead-shielded bunker wall, with a stick figure technician observing safely through a periscope, dark slate background (#12141B), industrial amber warning lights (#FFAA00) and steel gray tones, clean 2D vector style, bold outlines, strictly no text, no danger signs, no 3D render."
    },
    {
        "scene_id": "31",
        "act": 5,
        "act_title": "The Aftermath & Legacy",
        "timestamp_range": "9:20 - 9:40",
        "start_sec": 560.0,
        "end_sec": 580.0,
        "duration_sec": 20.0,
        "kinetic_hook_headline": "MELTED AT BIKINI",
        "voiceover_text": "What happened to the Demon Core itself? Initially slated for the Able nuclear test at Bikini Atoll, officials delayed its detonation to verify its physical integrity. In July 1946, the core was melted down, recooled, and reconstituted into new weapon pits that were later detonated over the Pacific Ocean.",
...
for sc in scenes_data:
    words = len(sc["voiceover_text"].split())
    sc["word_count"] = words
    total_words += words

manifest = {
    "project": "The Demon Core: How a Flathead Screwdriver Almost Blew Up Los Alamos",
    "series": "Deadly Elements & Bizarre Scientific Disasters",
    "channel": "NEON ATOM (@NeonAtomDocs)",
    "fps": 30,
...
out_path = r"c:\Users\bati-\Documents\AG-Stick\projects\demon-core-10min\script\storyboard_32_scenes.json"
with open(out_path, "w", encoding="utf-8") as f:
    json.dump(manifest, f, indent=2, ensure_ascii=False)

print(f"Successfully wrote {len(scenes_data)} scenes ({total_words} words) to {out_path}")
