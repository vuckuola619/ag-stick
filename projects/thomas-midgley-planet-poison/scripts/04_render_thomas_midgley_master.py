...
RAW_VIDEO = os.path.join(EXPORT_DIR, "thomas_midgley_10min_raw.mp4")
FINAL_MASTER = os.path.join(EXPORT_DIR, "the_man_who_poisoned_the_planet_10min_master.mp4")

os.makedirs(EXPORT_DIR, exist_ok=True)

def render_thomas_midgley_remotion():
    print("=======================================================================", flush=True)
    print("=== [1/2] Rendering Remotion Composition 'ThomasMidgley10Min'       ===", flush=True)
...
def mux_broadcast_audio():
    ...
    if os.path.exists(FINAL_MASTER) and os.path.getsize(FINAL_MASTER) > 0:
        ...
        print(f"\n[SUCCESS] Final 10-Minute Master Video Ready!", flush=True)
...
def main():
    render_thomas_midgley_remotion()
    mux_broadcast_audio()
